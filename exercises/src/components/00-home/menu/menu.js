  ...
  return (
    <nav>
        <ul>
            ...
            <li><Link to="/profilecard">ProfileCard</Link></li>

            <li><Link to="/bootstrapstatic">BootstrapStatic</Link></li>
            <li><Link to="/bootstrapdynamic">BootstrapDynamic</Link></li>
